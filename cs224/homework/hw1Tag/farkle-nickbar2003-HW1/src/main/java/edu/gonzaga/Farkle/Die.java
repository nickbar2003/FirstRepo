...
public class Die implements Comparable<Die> {
    ...
    /**
     * Setter for the sideUp field
     * 
     * @param Integer denoting the side to be facing up
     */
    public void setSideUp(Integer sideUp) {
        this.sideUp = sideUp;
    }
    ...
    public String toString() {
        String ret = "";
        // ret += "Die: " + this.sideUp.toString() + " of " + this.numSides.toString() +
        // " sides";
