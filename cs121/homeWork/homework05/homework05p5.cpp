...
int main() {
    ...
    std::cout << "Starting simuation\n\n";
    while(heightOfPumpkin_m > heightOfGround) {
        
        for(double counter = heightOfPumpkin_m; counter > heightOfPumpkin_m; counter--) {
            std::cout << "\n";
        }
        for(double counter = 0; counter < distance_m; counter++){
            std::cout << " ";
        }
        std::cout << "@\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";

        //std::cout << "Time (ms): " << timeSinceLaunch_ms << " -- altitude: " << heightOfPumpkin_m << " -- velocity: " << currentVelocity << " distance is: " << distance_m << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";
